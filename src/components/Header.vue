...
<template>
  <header class="header">
    <nav class="navbar navbar-expand-md navbar-light navbarTop">
      <div class="container-fluid">
        <router-link class="navbar-brand ms-3" to="/">
          ...
          />
          <img
            src="../assets/img/headlinehub-logo.png"
            alt="Logo"
            width=""
            height="40"
        ...
        <router-link to="/profile">
          <i
            v-if="userName"
            class="bi bi-person fs-1 mx-3 pf"
            style="color: white"
          >
            {{ "" + " " + userName }}</i
          >
    ...
    <nav
      class="navbar navbar-expand-md navbar-light navbarBottom"
      :class="{ 'sticky-top': isScrolled }"
    >
      <div class="container-fluid">
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-3">
            ...
            <li class="nav-item">
              <router-link to="/pages/general" class="nav-link"
                >General</router-link
              >
            </li>
            <li class="nav-item">
              <router-link to="/pages/business" class="nav-link"
                >Business</router-link
              >
            </li>
            <li class="nav-item">
              <router-link to="/pages/entertainment" class="nav-link"
                >Entertainment</router-link
              >
            </li>
            <li class="nav-item">
              <router-link to="/pages/health" class="nav-link"
                >Health</router-link
              >
            </li>
            <li class="nav-item">
              <router-link to="/pages/science" class="nav-link"
                >Science</router-link
              >
            </li>
            <li class="nav-item">
              <router-link to="/pages/sports" class="nav-link"
                >Sports</router-link
              >
            </li>
            <li class="nav-item">
              <router-link to="/pages/technology" class="nav-link"
        ...
        <form class="d-flex ms-auto">
          ...
          <router-link :to="`/search/${searchText}`"
            ><button class="btn btn-outline-light" role="link">
              Search
            </button></router-link
          >
        </form>
