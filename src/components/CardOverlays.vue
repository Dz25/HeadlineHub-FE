    ...
    <div class="card bg-dark text-white">
        ...
        <div class="card-img-overlay">
            ...
            <div class="d-flex flex-column align-items-end">
                <p class="card-text"><small>{{ new Date(Date.parse(publishedAt)) }}</small></p>
            <p class="card-text"><small>By {{ author }}</small>
                <span><button class="btn btn-outline-light float-right" @click="showModal">Read More</button>
                </span>
            </p>
            </div>
